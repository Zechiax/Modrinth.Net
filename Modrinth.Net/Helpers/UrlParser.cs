...
public static class UrlParser
{
    ...
    /// </summary>
    public static Regex ModrinthUrlRegex { get; } = new Regex(@"(?:https:\/\/(?:www.)?modrinth.com\/(mod|modpack|resourcepack|plugin|shader|datapack)\/([\w!@$()`.+,""\-']{3,64}))", RegexOptions.Compiled);
    /// <summary>
    /// Regex for validating slugs
    /// </summary>
    public static Regex ModrinthSlugRegex { get; } = new Regex(@"(^[\w!@$()`.+,""\-']{3,64}$)", RegexOptions.Compiled);
    /// <summary>
    /// Regex for validating ids
    /// </summary>
    public static Regex ModrinthIdRegex { get; } = new Regex(@"(^[\w]{3,64}$)", RegexOptions.Compiled);
    ...
    public static bool ValidateModrinthSlug(this string slug) => ModrinthSlugRegex.IsMatch(slug);
    ...
    public static bool ValidateModrinthId(this string id) => ModrinthIdRegex.IsMatch(id);
}